  ...
  return (
    <>
        ...
        <div className='relative flex items-center group'>
          <MdChevronLeft onClick={slideLift} className='bg-white left-0 rounded-full absolute opacity-50 hover:opacity-100 cursor-pointer z-10 hidden group-hover:block' size={40} />
